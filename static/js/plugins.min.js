  ...
  return function e(r, t, n) {
      ...
      18: [function(e, r, t) {
          ...
          r.exports = function(e, r, t, s) {
              var o, i, a, c, l, u, p, h, f, d, m, _, g, b, k, v, x, y, C, A, w = e.lineMax, D = e.bMarks[r] + e.tShift[r], E = e.eMarks[r];
              ...
              o = !1) : o = !0) : v = !1,
              d = [e.bMarks[r]],
              e.bMarks[r] = D; D < E && (i = e.src.charCodeAt(D),
              n(i)); )
              ...
              !(D >= E)); h++)
                  if (62 !== e.src.charCodeAt(D++) || A) {
                      ...
                      o = !1) : o = !0) : v = !1,
                      d.push(e.bMarks[h]),
                      e.bMarks[h] = D; D < E && (i = e.src.charCodeAt(D),
                      n(i)); )
      ...
      25: [function(e, r, t) {
          ...
          r.exports = function(e, r, t, i) {
              var a, c, l, u, p, h, f, d, m, _, g, b, k, v, x, y, C, A, w, D, E, q, S, F, L, z, T, I, R = !1, M = !0;
              if (e.sCount[r] - e.blkIndent >= 4)
                  return !1;
              ...
              e.parentType = "list"; x < t; ) {
                  for (q = S,
                  v = e.eMarks[x],
                  h = y = e.sCount[x] + S - (e.bMarks[r] + e.tShift[r]); q < v; ) {
                      if (9 === (a = e.src.charCodeAt(q)))
                          y += 4 - (y + e.bsCount[x]) % 4;
                      else {
                          if (32 !== a)
                              break;
      ...
      35: [function(e, r, t) {
          ...
          function s(e, r) {
              var t, s, c, p, h, f, d, m, _, g, b, k, v, x, y, C, A, w, D, E, q;
              for (D = [],
              t = 0; t < e.length; t++) {
                  for (s = e[t],
                  d = e[t].level,
                  ...
                  "text" === s.type) {
                      ...
                      p = l.exec(c)); ) {
                          ...
                          p.index - 1 >= 0)
                              ...
                              for (A = t - 1; A >= 0 && ("softbreak" !== e[A].type && "hardbreak" !== e[A].type); A--)
                                  if ("text" === e[A].type) {
                          ...
                          h < f)
                              ...
                              for (A = t + 1; A < e.length && ("softbreak" !== e[A].type && "hardbreak" !== e[A].type); A++)
                                  if ("text" === e[A].type) {
                              ...
                              if (C)
                                  ...
                                  !(D[A].level < d)); A--)
                                      if (m.single === w && D[A].level === d) {
                                          m = D[A],
                                          w ? (E = r.md.options.quotes[2],
                                          q = r.md.options.quotes[3]) : (E = r.md.options.quotes[0],
                                          q = r.md.options.quotes[1]),
                                          s.content = n(s.content, p.index, q),
                                          e[m.token].content = n(e[m.token].content, m.pos, E),
                                          h += q.length - 1,
                                          m.token === t && (h += E.length - 1),
                                          f = (c = s.content).length,
                                          D.length = A;
                                          continue e
                                      }
              ...
              !d[g] && (c || g && !m[g])) {
                  ...
                  if (!y) {
                      ...
                      n = C.length; t < n; t++) {
                          var A = C[t];
                          if (A && !A.match(h)) {
                              for (var w = "", D = 0, E = A.length; D < E; D++)
      ...
      60: [function(e, r, t) {
          (function(e) {
              !function(n) {
                  ...
                  var g, b, k = 2147483647, v = 36, x = 1, y = 26, C = 38, A = 700, w = 72, D = 128, E = "-", q = /^xn--/, S = /[^\x20-\x7E]/, F = /[\x2E\u3002\uFF0E\uFF61]/g, L = {
                  ...
                  if (g = {
                      ...
                      toUnicode: function(e) {
                          return i(e, function(e) {
                              return q.test(e) ? h(e.slice(4).toLowerCase()) : e
                          })
                      }
                  },
                  d && m)
...
// CONFIG PRISM AND CLIPBOARD
Prism.languages.insertBefore("js", "string", {
    arrow: /(=>)/,
    new: /\b(new)\b/,
    punctuation2: /\b(of|in)\b/,
    spread: /\.{3}/,
    condicional: /\b(if|else)\b/,
    special: /\b(?:document|window)\b/,
    "function-2": /([\w][\w]*)(?=: function)/gi,
    "object-property": /([A-Za-z]+(\:))/gi,
    property: /(?:\.)[A-Za-z][\w]*(?=[\s.]|\)|\;)/g,
    float: /\b\d*\.?\d/g,
    json: /"\w+"\:/g
}),
        ...
        if (Prism.plugins.toolbar) {
            ...
            Prism.plugins.toolbar.registerButton("copy-to-clipboard", function(t) {
                ...
                function e() {
                    ...
                    e.on("error", function() {
                        n.textContent = "Aperte Ctrl+C para copiar",
                        a()
                    })
                }
                function a() {
                    setTimeout(function() {
                        n.textContent = "Copiar"
                    }, 5e3)
                }
            })
        } else
